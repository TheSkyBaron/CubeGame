...
namespace Game.Data
{
    public class VehicleSave : MonoBehaviour
    {
        ...
        private readonly string SaveDataType = Settings.SaveFileType;
        ...
        private void Start()
        {
            ...
            Settings.SaveFoldersPath = Application.persistentDataPath + "/" + Settings.SaveFileFoldersName;
        }

        public void SaveVehicle()
        {
            string FolderPath = Settings.SaveFoldersPath;
            string FilePath = FolderPath + "/" + VehicleName.text + "/" + VehicleName.text + SaveDataType;
            if (!Directory.Exists(FolderPath + "/" + VehicleName.text)) Directory.CreateDirectory(FolderPath + "/" + VehicleName.text);
