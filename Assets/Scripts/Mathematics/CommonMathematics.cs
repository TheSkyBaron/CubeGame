...
namespace Game.Mathematics
{
    public static class CommonMathematics
    {
        ...
        public static Vector2 CalculateUV(Vector3 FaceVertexCoords, int FaceIndex)
        {
            switch (FaceIndex)
            {
                case 0:
                case 2:
                    return (Vector2)FaceVertexCoords;
                case 1:
                case 3:
                    return new Vector2(FaceVertexCoords.x, FaceVertexCoords.z);
                case 4:
                case 5:
                    return new Vector2(FaceVertexCoords.z, FaceVertexCoords.y);
                default:
                    break;
            }
