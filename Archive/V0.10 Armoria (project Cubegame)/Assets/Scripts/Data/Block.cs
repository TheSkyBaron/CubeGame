...
namespace Game.Data
{
    ...
    public class BlockRenderData
    {
        ...
        public BlockRenderData (Blocktypes Type, Vector3[,] _BlockVerticies, int[,] _BlockTriangles, int3[] _FaceCheckVectors,byte FaceBitMask)
        {
            FaceCount = 6;
            BlockType = Type;
            ...
            _FaceCheckSteps = new int[] { 0, 1, 2, 3, 4, 5 };
        }
