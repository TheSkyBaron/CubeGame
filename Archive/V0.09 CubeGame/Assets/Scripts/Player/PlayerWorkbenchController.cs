...
namespace Game.Player
{
    public class PlayerWorkbenchController : MonoBehaviour
    {
        ...
        private InputAction Move, Look, Zoom, Hold, Place, RemoveSwitch, EditorModeSwitcher, Inventory, SlotSelector,BlockRotateZAxis;
        ...
        private Byte3 LastRotation;

        private int[] ToolbarSlots = new int[] { 1, 2, 1, 1, 1, 1, 1, 1, 1 };
