...
namespace Game.Utils
{
    public static class GameUtils
    {
        ...
        public static BlockRenderData DeepCopyBlockData(BlockRenderData Target)
        {
            ...
            return new BlockRenderData(Target.FaceCount, Target.BlockType, TempBlockVectors, TempBlockTriangles, TempBlockFaceCheckVectors, TempFaceCheckSteps, Target._FaceBitmask);
        }
