...
namespace Game.Utils
{
    ...
    {
        GridBlock TestBlock = new GridBlock()
        {
         ID = 1,
         Rotation = Byte3.Zero,
        };
        ...
        public void ChangeBlock()
        {
            ...
            int.TryParse(IDText.text.Substring(0,IDText.text.Length -1),out TargetID);
            if (TargetID == 0 || TargetID < 0 || TargetID > CompiledBlockAtlas.BlockAtlas.Length) TargetID = 1;
            ReRenderObject();
        }
        ...
        private IEnumerator ScreenShot()
        {
            ...
            Rect TextureData = new Rect(Settings.PhotoshootStartPixelPosition.x, Settings.PhotoshootStartPixelPosition.y, Settings.PhotoshootImageWidth, Settings.PhotoshootImageHeight);
